...
# author: Hankyu Kim
title: "Understanding FABRIK: A Simple Guide"
...
While FABRIK handles most chain types efficiently, its main limitations involve **joint type flexibility**. Ball-and-socket and hinge joints are well-supported, but more complex joint constraints may require additional modifications.